...
nmap <Leader>rr :wa<CR> :VimuxRunLastCommand<CR>
nmap <Leader>rn :wa<CR> :VimuxPromptCommand<CR>
nmap <Leader>m :wa<CR> :VimuxRunCommand("make")<CR>
nmap <Leader>b :wa<CR> :VimuxRunCommand("make && make run")<CR>
nmap <Leader>t :wa<CR> :VimuxRunCommand("make test")<CR>
